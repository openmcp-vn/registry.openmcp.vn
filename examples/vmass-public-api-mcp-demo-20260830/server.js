...
const tools = [{"name": "get_v1_orders", "description": "GET /v1/orders", "input_schema": {"type": "object"}}, {"name": "post_v1_orders", "description": "POST /v1/orders", "input_schema": {"type": "object"}}];
const info = { name: "VMASS Public API MCP Demo", version: "0.1.0" };
